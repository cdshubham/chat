...
function NewGroupForm() {
  ...
  return (
    <div className="">
      <button
        className="bg-blue-500 h-10 text-xl rounded-xl hover:bg-blue-600 hover:text-white fixed p-1 m-2"
          ...
          <div className="mb-4">
            ...
            <form onSubmit={HandleAddNewGroup}>
              ...
              <div className=" mt-4 px-4">
                <button
                  className="bg-black text-white text-xl p-2 rounded w-full hover:bg-gray-500 hover:text-black"
                  type="submit"
                >
                  Create
                </button>
